...
from utils.dataloaders import IMG_FORMATS, VID_FORMATS, LoadImages, LoadScreenshots, LoadStreams, LoadNumpy, DEPTH_FORMATS
...
def run(
    ...
    de_is_file = Path(de_source).suffix[1:] in (DEPTH_FORMATS)
    ...
    # Dataloader
    bs = 1  # batch_size
    dataset = LoadNumpy(im_source, de_source, img_size=imgsz, stride=stride, auto=pt, vid_stride=vid_stride)
